...
class DrSmartViewModel: ObservableObject {
    ...
    @Published var processArr = [
        Process(isActive: true, isLoading: false,activeIcon: "ic_linear_devices"),
        Process(isActive: false, isLoading: true ,activeIcon: "ic_linear_router", inActiveIcon: "ic_linear_inActive_router"),
        Process(isActive: false, isLoading: false,activeIcon: "ic_linear_global", inActiveIcon: "ic_linear_inActive_global")
    ]
